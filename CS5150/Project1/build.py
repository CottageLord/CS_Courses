# Adapted from CS 5850, Building Game Engine course assignment, Northeastern University #
# --Yang Hu
import os
import platform
...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I ./src/ -I ./../common/thirdparty/glm/"
    LIBRARIES="-ldl"
elif platform.system()=="Darwin":
    ARGUMENTS="-D MAC" # -D is a #define sent to the preprocessor.
    INCLUDE_DIR="-I ./src/"
    LIBRARIES="-F/Library/Frameworks -framework"
